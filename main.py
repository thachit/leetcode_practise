...
from src.longest_common_prefix import main as longest_common_prefix_main
from src.valid_parenthless import main as valid_parenthless_main

# Press the green button in the gutter to run the script.
if __name__ == '__main__':
    valid_parenthless_main()
